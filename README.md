# Autonomous Disaster Fleet

Autonomous Disaster Fleet is a disaster-response management platform that combines **live simulation**, **backend orchestration**, and **AI-assisted mission decisions** in a single system.
